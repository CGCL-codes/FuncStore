...
class block_registration_serviceIfSingletonFactory : virtual public block_registration_serviceIfFactory {
 public:
  block_registration_serviceIfSingletonFactory(const ::std::shared_ptr<block_registration_serviceIf>& iface) : iface_(iface) {}
  virtual ~block_registration_serviceIfSingletonFactory() {}

  virtual block_registration_serviceIf* getHandler(const ::apache::thrift::TConnectionInfo&) override {
    return iface_.get();
  }
  virtual void releaseHandler(block_registration_serviceIf* /* handler */) override {}

 protected:
  ::std::shared_ptr<block_registration_serviceIf> iface_;
};

class block_registration_serviceNull : virtual public block_registration_serviceIf {
 public:
  virtual ~block_registration_serviceNull() {}
  void add_blocks(const std::vector<std::string> & /* block_ids */) override {
    return;
  }
  void remove_blocks(const std::vector<std::string> & /* block_ids */) override {
    return;
  }
};
...
class block_registration_service_add_blocks_args {
 public:
  ...
  block_registration_service_add_blocks_args() noexcept {
  }

  virtual ~block_registration_service_add_blocks_args() noexcept;
...
class block_registration_service_add_blocks_pargs {
 public:
  ...
  virtual ~block_registration_service_add_blocks_pargs() noexcept;
...
class block_registration_service_add_blocks_result {
 public:
  ...
  block_registration_service_add_blocks_result() noexcept {
  }

  virtual ~block_registration_service_add_blocks_result() noexcept;
...
class block_registration_service_add_blocks_presult {
 public:
  ...
  virtual ~block_registration_service_add_blocks_presult() noexcept;
  block_registration_service_exception ex;
...
class block_registration_service_remove_blocks_args {
 public:
  ...
  block_registration_service_remove_blocks_args() noexcept {
  }

  virtual ~block_registration_service_remove_blocks_args() noexcept;
  std::vector<std::string>  block_ids;
...
class block_registration_service_remove_blocks_pargs {
 public:
  ...
  virtual ~block_registration_service_remove_blocks_pargs() noexcept;
  const std::vector<std::string> * block_ids;
...
class block_registration_service_remove_blocks_result {
 public:
  ...
  block_registration_service_remove_blocks_result() noexcept {
  }

  virtual ~block_registration_service_remove_blocks_result() noexcept;
  block_registration_service_exception ex;
...
class block_registration_service_remove_blocks_presult {
 public:
  ...
  virtual ~block_registration_service_remove_blocks_presult() noexcept;
  block_registration_service_exception ex;
...
class block_registration_serviceClientT : virtual public block_registration_serviceIf {
 public:
  block_registration_serviceClientT(std::shared_ptr< Protocol_> prot) {
    setProtocolT(prot);
  }
  block_registration_serviceClientT(std::shared_ptr< Protocol_> iprot, std::shared_ptr< Protocol_> oprot) {
...
class block_registration_serviceProcessorT : public ::apache::thrift::TDispatchProcessorT<Protocol_> {
 ...
 public:
  block_registration_serviceProcessorT(::std::shared_ptr<block_registration_serviceIf> iface) :
    iface_(iface) {
...
class block_registration_serviceProcessorFactoryT : public ::apache::thrift::TProcessorFactory {
 public:
  block_registration_serviceProcessorFactoryT(const ::std::shared_ptr< block_registration_serviceIfFactory >& handlerFactory) noexcept :
      handlerFactory_(handlerFactory) {}

  ::std::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) override;

 protected:
  ::std::shared_ptr< block_registration_serviceIfFactory > handlerFactory_;
};
...
class block_registration_serviceMultiface : virtual public block_registration_serviceIf {
 public:
  block_registration_serviceMultiface(std::vector<std::shared_ptr<block_registration_serviceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~block_registration_serviceMultiface() {}
 protected:
  std::vector<std::shared_ptr<block_registration_serviceIf> > ifaces_;
  block_registration_serviceMultiface() {}
  void add(::std::shared_ptr<block_registration_serviceIf> iface) {
...
class block_registration_serviceConcurrentClientT : virtual public block_registration_serviceIf {
 public:
  block_registration_serviceConcurrentClientT(std::shared_ptr< Protocol_> prot, std::shared_ptr< ::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocolT(prot);
  }
  block_registration_serviceConcurrentClientT(std::shared_ptr< Protocol_> iprot, std::shared_ptr< Protocol_> oprot, std::shared_ptr< ::apache::thrift::async::TConcurrentClientSyncInfo> sync) : sync_(sync)
{
    setProtocolT(iprot,oprot);
  }
 private:
